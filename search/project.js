...
const projects = [{
        title: "Anti Drone Surveillance System",
        cardImage: "p.webp",
        description: "",
        tag: "hardware",
        Previewlink: "../hardware/index.html",
        // Githublink: "https://github.com/jheel05/DSC_WOW_ABHAVYA.git",
    }, {
        title: "A woman safety website",
        cardImage: "p.webp",
        description: "A website built using HTML, CSS AND Js.",
        tag: "web dev",
        Previewlink: "../web/index.html",
        // Githublink: "https://github.com/jheel05/DSC_WOW_ABHAVYA.git",
    },
    {
    ...
    {
        title: "Nirogya-Healthcare Website",
        cardImage: "p.webp",
        description: "A website build to focus on Healthcare",
        tag: "ai/ml",
        Previewlink: "",
